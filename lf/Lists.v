...
Theorem add_incr_count: forall (n:nat) (v:bag), 
     count n (add n v) = 1 + count n v.
Proof. 
  intros n v. simpl. rewrite -> eqb_refl. reflexivity. Qed.
...
Proof.
  intros n s1 s2. induction s1 as [|n1 s1' IHs1'].
  - simpl. reflexivity. 
  - simpl. destruct (n =? n1).
